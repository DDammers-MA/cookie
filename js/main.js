class Cookie{
    ...
    onStyleChangeLightGreen(){
        this.htmlElement.classList.add("cookie--LightGreen");
    }
}
...
class LightGreenCookie{
    ...
    constructor(htmlElement, cookie){
        this.htmlElement = htmlElement;
        this.cookie = cookie;
        this.htmlElement.onclick = this.onLightGreenCookieClicked;
    }

    onLightGreenCookieClicked = () =>{
        if(this.bought === false){
            this.bought = true;
            this.cookie.onStyleChangeLightGreen();
...
const LightGreen = new LightGreenCookie(document.getElementById("js--LightGreen"), cookie);
...
const LightGreenMobile = new LightGreenCookie(document.getElementById("js--LightGreen--Mobile"), cookie);